...
use linear_interpolation
  ...
  double precision:: al, kl, spm, b(2), c(100,100), areat, diamt, ui(1,1), vi(1,1), mwf, lo,wvp, rrr
 ...
 !  print*, 10, tsevol(contind),  tsevol(contind-1)
   ...
   if(parcelcont.gt.0) then
    ...
    do m1=1,parcelcont
      ...
      ui1f2 = u_model1 (lat_in_f2(1), lon_in_f2(2), indexz(1))
      ui2f2 = u_model2 (lat_in_f2(1), lon_in_f2(2), indexz(1))
      vi1f2 = v_model1 (lat_in_f2(1), lon_in_f2(2), indexz(1))
      vi2f2 = v_model2 (lat_in_f2(1), lon_in_f2(2), indexz(1))
      wi1f2 = w_model1 (lat_in_f2(1), lon_in_f2(2), indexz(1))
      wi2f2 = w_model2 (lat_in_f2(1), lon_in_f2(2), indexz(1))
      kz1f2 = kz_model1 (lat_in_f2(1), lon_in_f2(2), indexz(1))
      kz2f2 = kz_model2 (lat_in_f2(1), lon_in_f2(2), indexz(1))
