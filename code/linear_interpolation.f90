...
! print*, 'bhna', varin1, varin2
        ...
        slic_t1_2 = t_model1 (lat_in_r-slic : lat_in_r+slic, lon_in_r - slic : lon_in_r + slic, varin2)
        slic_t2_2 = t_model2 (lat_in_r-slic : lat_in_r+slic, lon_in_r - slic : lon_in_r + slic, varin2)  
        slic_s1_2 = s_model1 (lat_in_r-slic : lat_in_r+slic, lon_in_r - slic : lon_in_r + slic, varin2)
        slic_s2_2 = s_model2 (lat_in_r-slic : lat_in_r+slic, lon_in_r - slic : lon_in_r + slic, varin2)  
